...
nums = [1, 5, 2, 4, 3]
#
#  To find the first value of the 'courses' list above, you'd put:  print(courses[0]).  Last would be [3]
...
#				What if you want the 9?  Then you'd put [1:]  (Leave the 0 out)
#
...
#
# HOW TO COUNT BACKWARDS:  Start from the negative and go to the positive, USING A NEGATIVE STEP.
# NOTE:						The end index is exclusive, EVEN WHEN GOING IN REVERSE!
#
# EXAMPLE:		print(my_list[-1:0:-1])  This would print 9 through 1, in reverse.
# EXAMPLE       print(my_list[::-1])    This would print the entire list, in reverse.
#
# 
...
#
#
# Refer back to "courses", and "art_courses" up top.
#
#------------------------ADDING THINGS, INCLUDING LISTS, TO OTHER LISTS----------------------
#
...
#
# SORTING YOUR LIST, DESCENDING: Yes, you can use the .reverse method on the list when they're sorted, but EASEIER:
#
...
#--------------------------------MIN, MAX, AND SUM---------------------------------
#
#  If you want the minimum value of the numbers list way up top:
#
#print(min(nums))
#
#  If you want the maximum value of the list:
#
#print(max(nums))
#
#  If you want the sum of the list:
#
#print(sum(nums))
...
# NOTE THE   ^ DUPLICATE MATH, AND CURLEY BRACES INSTEAD OF O^THERWISE
#
#print(cs_courses)
#
...
#------------------------------------COMPARING SETS-------------------------------------------
#
#FINDING THE INTERSECTION OF SETSUse the .intersection METHOD on the cs_courses SET.
#
