...
#OTHERWISE, STRING FORMATTING IS BELOW

string_formatting_message = "{}, {}. Welcome Number 2!".format(greeting2, name2)  # THIS IS STRING FORMATTING.  SAME THING AS ABOVE, ONLY
#LONGER
#------------------------------------------------------------

#------------HELP FUNCTIONS BELOW---------------

message_dir_help = print(dir(name))  # THE "DIR" FUNCTION SHOWS ME ALL ATTRIBUTES AND METHODS AVIALABLE IN THAT VARIABLE

message_string_help = print(help(str)) # EXPLAINS IN *EXTREME* DETAIL OF WHAT THESE METHODS DO, AND WHAT ARGUMENTS THEY HAVE.  EXTREMELY USEFUL.
#   ALSO MODIFYABLE LIKE "str.lower", FOR EXAMPLE.
#------------HELP FUNCTIONS ABOVE----------------
#--------------------------------------------------------------
#------------END OF INTERNAL DETAILS AND SET FUNCTIONS-----------


print(fstringmessage) 
